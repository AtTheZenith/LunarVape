...
run(function()
  ...
  if starterGui:GetCoreGuiEnabled(Enum.CoreGuiType.Health) then
    repeat
      task.wait()
    until not starterGui:GetCoreGuiEnabled(Enum.CoreGuiType.Health) or LunarVape.Loaded == nil
...
run(function()
  ...
  entitylib.start = function()
    ...
    table.insert(
      ...
      ad.Network:Connect('PlayerSpawned', function(plr)
        task.defer(function()
          local ent = ad.ReplicationPlayers[plr]
          if ent then
    ...
    table.insert(
      entitylib.Connections,
      ad.Memory:GetMemoryChangedSignal('Character'):Connect(function()
        task.defer(function()
